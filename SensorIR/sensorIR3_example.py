...
openni2.initialize(r'C:\Users\gabri\OneDrive\Documentos\RYMA-Maestria-Tesis\win64\win64\bin')#'C:\Program Files\OpenNI2\Redist\OpenNI2.dll') # accepts the path of the OpenNI redistribution
...
while not done:
    ...
    cv2.imshow("IR image", np.hstack(ir4d))
    frame_idx+=1
# end while

cv2.imwrite('frame01.png', ir4d)
